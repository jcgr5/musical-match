...
type UserRole = "CLIENT" | "MUSICIAN" | "ADMIN";
...
export function Navbar({ searchTerm = "", onSearchChange }: NavbarProps) {
    ...
    // Esta función simula un estado de autenticación
    // En una implementación real, esto vendría de un contexto de autenticación o similar
    const isAuthenticated = true; // Cambiar según necesidad
    const userRole: UserRole = "MUSICIAN"; // Para pruebas
        ...
        <header className="sticky top-0 z-50 w-full bg-white dark:bg-slate-800 shadow-sm">
            <div className="container mx-auto px-4">
                ...
                <div className="hidden md:flex items-center justify-between h-16">
                    ...
                    {/* Barra de búsqueda central que ocupa la mayor parte del espacio */}
                            ...
                            <>
                                ...
                                <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
                                    ...
                                    <DropdownMenuContent align="end">
                                        ...
                                        <DropdownMenuSeparator />
                                        <DropdownMenuItem className="text-red-500" onClick={handleMenuItemClick}>
